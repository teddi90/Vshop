                ...
                <div class="lg:w-4/5 mx-auto flex flex-wrap">
                    <div class="flex flex-wrap w-1/2">
                        <div class="md:p-2 p-1 w-full">
                            <img v-if="currentImg" :alt="product.title" class="w-full h-full object-cover object-center block rounded" :src="`/${currentImg}`">
                        ...
                        <template v-if="product.product_images.length>1">
                            <div v-for="(img,inx) in product.product_images" class="md:p-2 p-1 w-1/2">
                                <img @click="setCurrentImg(inx)"
                                     :class="{ 'border-2 border-blue-400': currentImg===img.image}"
                                    :alt="product.title" class="w-full object-cover h-full object-center block rounded" :src="`/${img.image}`">
                            </div>
                        </template>
                    </div>
